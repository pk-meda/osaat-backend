...
urlpatterns = [
    ...
    path(
        ...
        views.RefractionExaminationAPIView.as_view(),
        name="Refraction-Examination",
    ),
    path("Diagnosis", views.DiagnosisView.as_view(), name="Diagnosis"),
    path("Profile", views.ParticipantView.as_view(), name="Profile"),
    path(
        "Spectacle-History",
        views.SpectacleHistoryAPIView.as_view(),
        name="Spectacle-History",
    ),
    path(
        "Surgery-History",
        views.SurgeryTreatmentHistoryAPIView.as_view(),
    ...
    path(
        "Current_Medical", views.CurrentMedicalAPIView.as_view(), name="Current_Medical"
    ),
    path(
        "VisualAcuity",
        views.VisualAcuityMeasurementAPIView.as_view(),
        name="VisualAcuity",
    ),
    path(
        "RefractionSpectacle",
        views.RefractionSpectacleAPIView.as_view(),
    ...
    path(
        "ali-text-search",
        views.AliExpressProductSearchAPIView.as_view(),
        name="ali-text-search",
    ),
    path(
