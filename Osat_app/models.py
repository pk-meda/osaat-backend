...
class RefractionExamination(models.Model):
    reference_number = models.CharField(max_length=50, unique=True)
    chief_complaint = models.CharField(max_length=255, choices=[
...
class SpectacleHistory(models.Model):
    ...
    lens_condition = models.CharField(
        max_length=20, choices=[('good', 'Good'), ('scratched', 'Scratched'),
                                ('dirty', 'Dirty'), ('broken', 'Broken')],
        null=True, blank=True
    )

    lens_material = models.CharField(
        max_length=10, choices=[('glass', 'Glass'), ('plastic', 'Plastic')],
        null=True, blank=True
    )

    lens_coating = models.CharField(
        max_length=20, choices=[('hard coat', 'Hard Coat'), ('arc', 'ARC'), ('blue coat', 'Blue Coat')],
        null=True, blank=True
    )

    lens_type = models.CharField(
        max_length=20, choices=[('single vision', 'Single Vision'), ('bifocal', 'Bifocal'),
                                ('multifocal', 'Multifocal'), ('lenticular', 'Lenticular')],
        null=True, blank=True
    )

    refractive_index = models.FloatField(null=True, blank=True, choices=[(1.5, '1.5'), (1.56, '1.56'),
                                                                         (1.67, '1.67'), (1.71, '1.71')])
    ...
    glasses_source = models.CharField(
        max_length=50,
        choices=[('eye hospital', 'Eye Hospital'), ('vision center', 'Vision Center'),
                 ('optical store', 'Optical Store'), ('eye camp', 'Eye Camp'),
                 ('school eye health event', 'School Eye Health Event'),
                 ('dont know', "Don't Know"), ('other', 'Other')],
        null=True, blank=True
    )
    ...
    satisfaction_level = models.CharField(
        max_length=20, choices=[('very happy', 'Very Happy'), ('happy', 'Happy'),
                                ('ok', 'OK'), ('unhappy', 'Unhappy'), ('very unhappy', 'Very Unhappy')],
        null=True, blank=True
    )
...
class SurgeryTreatmentHistory(models.Model):
    ...
    def __str__(self):
        return f"Record {self.reference_number} - {self.treated_eye} - {self.surgery_type}"
...
class FamilyHistory(models.Model):
    ...
    Other_glasses = models.BooleanField(default=False)  # Renamed to match "OtherGlasses"
    ...
    search_term = models.CharField(max_length=100, blank=True, null=True)  # Fixed "SerachTerm" typo
...
class CurrentMedicalTreatment(models.Model):
    ...
    treatment_eye = models.CharField(max_length=50, choices=[('Right_eye','Right_eye'),
                                                             ('Left_eye','Left_eye'),
                                                             ('Both','Both'),
                                                             ('Systemic','Systemic')])

    medicine_type = models.CharField(max_length=50, choices=[('Eye drop','Eye drop'),
    ...
    times_per_day = models.IntegerField(choices=[(1,'one time a day'),
                                                  (2,'twice a day'),
                                                  (3,'three times a day'),
                                                  (4,'four times a day'),
                                                  (5, 'five times a day')])
...
class VisualAcuityMeasurement(models.Model):
    ...
    unaided_distance_va_re = models.CharField(max_length=50, choices=VISUAL_ACUITY_DISTANCE_CHOICES, blank=True, null=True)
    unaided_distance_va_le = models.CharField(max_length=50, choices=VISUAL_ACUITY_DISTANCE_CHOICES, blank=True, null=True)
    unaided_near_va_re = models.CharField(max_length=50, choices=VISUAL_ACUITY_NEAR_CHOICES, blank=True, null=True)
    unaided_near_va_le = models.CharField(max_length=50, choices=VISUAL_ACUITY_NEAR_CHOICES, blank=True, null=True)
    aided_distance_va_re = models.CharField(max_length=50, choices=VISUAL_ACUITY_DISTANCE_CHOICES, blank=True, null=True)
    aided_distance_va_le = models.CharField(max_length=50, choices=VISUAL_ACUITY_DISTANCE_CHOICES, blank=True, null=True)
    aided_near_va_re = models.CharField(max_length=50, choices=VISUAL_ACUITY_NEAR_CHOICES, blank=True, null=True)
    aided_near_va_le = models.CharField(max_length=50, choices=VISUAL_ACUITY_NEAR_CHOICES, blank=True, null=True)
    ph_distance_va_re = models.CharField(max_length=50, choices=VISUAL_ACUITY_DISTANCE_CHOICES, blank=True, null=True)
    pd_distance_va_le = models.CharField(max_length=50, choices=VISUAL_ACUITY_DISTANCE_CHOICES, blank=True, null=True)
...
class RefractionSpectacle(models.Model):
    reference_number = models.CharField(max_length=100, unique=True)
    spherical_prescription_re = models.CharField(max_length=50, choices=SPH_CHOICES, blank=True, null=True)
    cylindrical_prescription_re = models.CharField(max_length=50, choices=CYL_CHOICES, blank=True, null=True)
    axis_cylinder_re = models.CharField(max_length=50, choices=AXIS_CHOICES, blank=True, null=True)
    spherical_prescription_le = models.CharField(max_length=50, choices=SPH_CHOICES, blank=True, null=True)
    cylindrical_prescription_le = models.CharField(max_length=50, choices=CYL_CHOICES, blank=True, null=True)
    axis_cylinder_le = models.CharField(max_length=50, choices=AXIS_CHOICES, blank=True, null=True)
