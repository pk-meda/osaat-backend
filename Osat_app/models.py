...
class RefractionExamination(models.Model):
    ...
    sph_RE_current = models.CharField(max_length=255, null=True, blank=True)
    cyl_RE_current = models.CharField(max_length=255, null=True, blank=True)
    axis_RE_current = models.CharField(max_length=255, null=True, blank=True)
    sph_LE_current = models.CharField(max_length=255, null=True, blank=True)
    cyl_LE_current = models.CharField(max_length=255, null=True, blank=True)
    axis_LE_current = models.CharField(max_length=255, null=True, blank=True)
    sph_RE_dry = models.CharField(max_length=255, null=True, blank=True)
    cyl_RE_dry = models.CharField(max_length=255, null=True, blank=True)
    axis_RE_dry = models.CharField(max_length=255, null=True, blank=True)
    sph_LE_dry = models.CharField(max_length=255, null=True, blank=True)
    cyl_LE_dry = models.CharField(max_length=255, null=True, blank=True)
    axis_LE_dry = models.CharField(max_length=255, null=True, blank=True)
    sph_RE_cyclo = models.CharField(max_length=255, null=True, blank=True)
    cyl_RE_cyclo = models.CharField(max_length=255, null=True, blank=True)
    axis_RE_cyclo = models.CharField(max_length=255, null=True, blank=True)
    sph_LE_cyclo = models.CharField(max_length=255, null=True, blank=True)
    cyl_LE_cyclo = models.CharField(max_length=255, null=True, blank=True)
    axis_LE_cyclo = models.CharField(max_length=255, null=True, blank=True)
    sph_RE_final = models.CharField(max_length=255, null=True, blank=True)
    cyl_RE_final = models.CharField(max_length=255, null=True, blank=True)
    axis_RE_final = models.CharField(max_length=255, null=True, blank=True)
    sph_LE_final = models.CharField(max_length=255, null=True, blank=True)
    cyl_LE_final = models.CharField(max_length=255, null=True, blank=True)
    axis_LE_final = models.CharField(max_length=255, null=True, blank=True)
    se_RE = models.CharField(max_length=255, null=True, blank=True)
    se_LE = models.CharField(max_length=255, null=True, blank=True)
    bcva_RE = models.CharField(max_length=255, null=True, blank=True)
    bcva_LE = models.CharField(max_length=255, null=True, blank=True)
    add_RE = models.CharField(max_length=255, null=True, blank=True)
    add_LE = models.CharField(max_length=255, null=True, blank=True)
